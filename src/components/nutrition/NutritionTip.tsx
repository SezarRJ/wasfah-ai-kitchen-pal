...
export const NutritionTip: React.FC<NutritionTipProps> = ({
  ...
  return (
    <Card className={`border-2 ${borderClass} bg-gradient-to-r ${bgClass} dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-800/80 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300`}>
